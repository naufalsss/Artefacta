...
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="card h-100 shadow-sm">
            ...
            {{-- IMAGE --}}
            <img src="{{ $menu->image ? asset('storage/'.$menu->image) : asset('img/placeholder.png') }}"
                 class="card-img-top"
            ...
            <div class="card-body">
                ...
                <p class="mb-1"><strong>Category:</strong> {{ $menu->category->name ?? '-' }}</p>
                <p class="mb-2"><strong>Price:</strong> Rp {{ number_format($menu->price,0,',','.') }}</p>
